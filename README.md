...
This application is configured for deployment on Render using the included `render.yaml` blueprint. The frontend is available at https://react-frontend-73hr.onrender.com/
...
**Backend Service:**
- `DATABASE_URL` - PostgreSQL connection string (I used a free tier Neon account that is connected to the deployed example)
