...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-yljr!++$2%^hhf1hyz2u71=119+(=*g*sdv%@zd*z1z*cmd6r$')
...
REST_FRAMEWORK = {
    'DEFAULT_PERMISSION_CLASSES': [
        'rest_framework.permissions.AllowAny',  # For hello world - restrict in production
    ],
}
